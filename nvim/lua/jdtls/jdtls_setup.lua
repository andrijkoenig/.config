...
function M:setup()
    ...
    local config = {
        ...
        cmd = {
            ...
            -- 💀
            "-jar",
            "C:\Users\andri\Downloads\jdt-language-server-1.52.0-202510301627.tar\jdt-language-server-1.52.0-202510301627\plugins\org.eclipse.equinox.launcher_1.7.100.v20251014-1222.jar",
